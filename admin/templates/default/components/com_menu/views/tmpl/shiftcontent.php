<div class="shiftcontent"  >
	...
	<ul>
		...
		<?php /** <li> <input type="radio"  name="next"   onclick="loadAllMenu(2)"  /> 放入回收站 </li> **/?>
...
<script language="javascript" >
	...
	function returnPrev(){
		//$.w.loadDialog('index.php?com=menu&task=selectcomtype&mtid=<?php echo $this->menutypeid;?>&id=<?php echo $_REQUEST['id'];?>&url[com]=<?php echo $_REQUEST['url']['com'];?>&no_html=1',0); 
	}
