...
<form action="index.php?com=users&no_html=1"  method="post"  id="menage_form"  > 
	<ul class="switch_con" >
	<li class="con active" > 
...
<table class="formtable" >
		...
		<tr >
			<td class="form_text" style=" border-bottom:1px solid #f0f0f0;" >
 				<b>联系方式</b>
 			</td>
			<td style=" border-bottom:1px solid #f0f0f0;"  >
			<SPAN style="color:red;" >（用于积分兑换后奖品的寄发，该信息只有您和管理员有权查看）</SPAN>
			</td>
		</tr>
