...
class LinktypeView extends view{
	var $rows;
	var $uid;
	var $path;
	function LinktypeView()
	{
            ...
            foreach( $items as $k=> $item )
            {
                ...
                if($item['published'] == 1 ){
                    ...
                    <?php
                        ...
                        <td>
                            <a href="<?php echo $this->baseuri;?>&task=edittype&id=<?php echo $item['id'];?>" class="list_edit">
                            编辑
                            </a>
                            &nbsp;
                            <?php
                            ...
                            ?>
                                <a href="<?php echo $this->baseuri;?>&task=deltype&id=<?php echo $item['id'];?>" class="list_del">
                                    删除
                                </a>
                            <?php
                            }
