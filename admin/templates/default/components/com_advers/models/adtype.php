...
class adtypeModel extends Model{
	var $tableName;
	var $assocTable;
	function adtypeModel()
	{
		parent::__construct();
		$this->tableName = '#__adver_types';
		$this->assocTable = '#__advers';
	}
    ...
    function save()
    {
        $data = array(
						...
						'params'=>($_POST['num'].'|'.$_POST['width'].'|'.$_POST['height']),
                    );
