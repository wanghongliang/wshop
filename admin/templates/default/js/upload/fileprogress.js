...
function FileProgress(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		var progressCLR = document.createElement("div");
		progressCLR.className = "clr";
		progressCLR.innerHTML = "&nbsp;";


		var progressBarPrecent = document.createElement("div");
		progressBarPrecent.className = "progressBarPrecent";
		progressBarPrecent.innerHTML = "&nbsp;";
		...
		this.fileProgressElement.appendChild(progressBarPrecent);
		this.fileProgressElement.appendChild(progressCLR);
