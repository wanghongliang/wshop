...
define('PATH_BASE',dirname(__FILE__));		//当前应用的目录
//定义根目录信息
define('PATH_ROOT',dirname(PATH_BASE));		//系统根目录
//载入框架信息
include(PATH_BASE.DS.'includes/framework.php');


$app = Factory::getApplication('admin');
//组件
$com = $_GET['com']?$_GET['com']:'cpanel';
