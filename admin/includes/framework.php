...
//插件路径定义
define('PATH_PLUGINS',PATH_ROOT.DS.'plugins');	//插件绝对路径


//模板路径定义
define('PATH_TEMPLATE',PATH_BASE.DS.'templates');	//模板绝对路径

//定义当前网站目录,如果在根目录就为 /				//URL 目录
...
define('PATH_PREVIEW',PATH_ROOT.DS.$config['preview_directory']);		



//定义当前URI根目录
if( $config['preview_directory'] == '' )
{
