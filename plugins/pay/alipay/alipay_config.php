...
//签约支付宝账号或卖家支付宝帐户
$seller_email	= "13530253280";


$partner        = "2088302448712140";       //合作伙伴ID
$security_code  = "x0tibk2qs2ubq2wq8x4t7j19dw9q4yer";       //安全检验码
$seller_email   = "13530253280";       //卖家支付宝帐户

//交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$notify_url		= URI::base();//."http://www.xxx.com/js_php_utf8/notify_url.php";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$return_url		= URI::base();//"http://www.xxx.com/js_php_utf8/return_url.php";
