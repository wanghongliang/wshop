class com.robertpenner.easing.Elastic
{
    ...
    static function easeOutIn(t, b, c, d, a, p)
    {
        ...
        if (t < 1)
        {
            return (5.000000E-001 * (a * Math.pow(2, -10 * t) * Math.sin((t * d - _loc7) * 6.283185E+000 / p)) + c / 2 + b);
        } // end if
        return (c / 2 + 5.000000E-001 * (a * Math.pow(2, 10 * (t - 2)) * Math.sin((t * d - _loc7) * 6.283185E+000 / p)) + b);
    } // End of the function
} // End of Class
