class com.robertpenner.easing.Bounce
{
    ...
    static function easeOutIn(t, b, c, d)
    {
        if (t < d / 2)
        {
            return (com.robertpenner.easing.Bounce.easeOut(t * 2, 0, c, d) * 5.000000E-001 + b);
        } // end if
        return (com.robertpenner.easing.Bounce.easeIn(t * 2 - d, 0, c, d) * 5.000000E-001 + c * 5.000000E-001 + b);
    } // End of the function
} // End of Class
