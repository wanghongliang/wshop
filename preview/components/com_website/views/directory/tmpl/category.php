		...
		<dd>
			...
			foreach( $rows as $row )
			{
				...
				<div class="cb" >
				 ...
				 <div class="opt" >
				<a href="<?php echo Router::_( WebsiteHelperRoute::getRoute($row['id'],$row['catid']) ); ?>" title="<?php echo $row['name'];?>" target=_blank  >点评</a>/<a href="javascript:addFav('<?php echo  $row['id']; ?>')"    >收藏</a>/<a href="javascript:sendError('<?php echo  $row['id']; ?>');"  >报错</a>
				 </div>
				 <div class="name" >
