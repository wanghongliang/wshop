<div class="sright">
	<h2 class="stitle2">
	预约:<span style="font-weight:normal; color:#ED0E0E;">送货、安装维修、移机、保养、清洗、上门设计、打墙洞、埋管线等服务可在此预约</span></h2>
	<div class="sgform">
		...
		<form action="<?php echo $uri->getByURL(array('a'=>'appo'));?>" method="post">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="reform">
				...
				<tr><th>服务类型：</th><td><input type="text" name="title" id="title" size="35" value="<?php echo $_GET['title'];?>" /></td></tr>
				<tr><th>预约信息：</th><td><textarea name="content" id="content" cols="50" rows="8"><?php echo $_GET['content'];?></textarea></td></tr>
				...
				<input type="hidden" name="return" value="<?php echo $uri->getByURL(array('a'=>'appo'));?>" />
				</td></tr>
			</table>
		</form>
	</div>       
