<div class="sright">
	<h2 class="stitle2">投诉信息<span style="font-weight:normal; color:#ED0E0E;"></span></h2>
	<div class="sgform">
			<div class="" >
			<?php
			$msg = $app->getMsg(); 
		...
		<form action="<?php echo $uri->getByURL(array('a'=>'comp'));?>" method="post">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="reform">

				<tr><th>投诉标题：</th><td><input type="text" name="title" id="title" size="35" value="<?php echo $_GET['title'];?>" /></td></tr>
				<tr><th>投诉内容：</th><td><textarea name="content" id="content" cols="50" rows="8"><?php echo $_GET['content'];?></textarea></td></tr>
				...
				<input type="hidden" name="return" value="<?php echo $uri->getByURL(array('a'=>'comp'));?>" />
				</td></tr>
