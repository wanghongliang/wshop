...
defined('PATH_BASE') or die();
 ...
 /**
 * WDocumentRenderer_RSS is a feed that implements RSS 2.0 Specification
 *
...
class WDocumentRendererRSS extends WDocumentRenderer
{
	/**
	 * Renderer mime type
	 *
	...
	function render()
	{
		...
		if ($data->pubDate!="") {
			$pubDate =& WFactory::getDate($data->pubDate);
		...
		for ($i=0; $i<count($data->items); $i++)
		{
			...
			*/
			...
			$itemDate =& WFactory::getDate($data->items[$i]->date);
