 ...
 * @since		1.5
 */
class WDocumentPDF extends WDocument
{
	var $_engine	= null;

	var $_name		= 'daybillion';
	...
	function __construct($options = array())
	{
		...
		// Installation path
		define("K_PATH_MAIN", PATH_LIBRARIES.DS."tcpdf");

		// URL path
		define("K_PATH_URL", PATH_BASE);

		// Fonts path
		define("K_PATH_FONTS", PATH_SITE.DS.'language'.DS."pdf_fonts".DS);
	 ...
	 * @return  void
	 */
	function setName($name = 'daybillion') {
		$this->_name = $name;
	}
	...
	function render( $cache = false, $params = array())
	{
		...
		//WResponse::setHeader('Content-Length', strlen($data), true);

		WResponse::setHeader('Content-disposition', 'inline; filename="'.$this->getName().'.pdf"', true);
