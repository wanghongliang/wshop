<?php
class WSimpleXML extends WObject
{
	/**
	 * The XML parser
	 *
	...
	*/
	 ...
	 * WSimpleXMLElement with properties containing the data held within the xml document.
	 * If any errors occur, it returns FALSE.
	 *
	 * @param string  Well-formed xml string data
	 * @param string  currently ignored
	 * @return object WSimpleXMLElement
	 */
	 ...
	 * to an object  of class WSimpleXMLElement. If any errors occur during file access or
	...
	/**
	 * Get a WSimpleXMLElement object from a DOM node.
	 *
	 * This function takes a node of a DOM  document and makes it into a WSimpleXML node.
	 * This new object can then be used as a native WSimpleXML element. If any errors occur,
	 * it returns FALSE.
	 *
	...
	{
		//WError::raiseWarning( 'SOME_ERROR_CODE' , 'XML Parsing Error at '.$line.':'.$col.'. Error '.$code.': '.xml_error_string($code));
	}
 ...
 *
 * @author		Wohan Wanssens <johan.janssens@joomla.org>
 * @package 	Woomla.Framework
 * @subpackage	Utilities
 * @since 1.5
 */
class WSimpleXMLElement extends WObject
{
	/**
	 ...
	 * @param array  $attrs
	 * @param int 	 $level
	 * @return WSimpleXMLElement 	The added child object
	 */
	...
	/**
	 * traverses the tree calling the $callback( WSimpleXMLElement
	 * $this, mixed $args=array() ) function with each WSimpleXMLElement.
	 *
