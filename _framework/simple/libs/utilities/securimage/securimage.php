...
class Securimage {
   ...
   * @var string
   */
  var $image_bg_color = "#fcfcfc";//"#e3daed";
  ...
  function Securimage()
  {
	$this->ttf_file = dirname(__FILE__).DS."elephant.ttf";
